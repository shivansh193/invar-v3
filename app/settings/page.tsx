        ...
        <div className="space-y-12">
          ...
          <section className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <SettingField label="Email address" value="jane@company.com" />
            </div>
          ...
          <section className="space-y-6">
            ...
            <div className="bg-[#1f1f25] border border-zinc-800 p-6 flex items-center justify-between">
              <div>
                <p className="text-sm font-bold text-white uppercase tracking-tight">Community Plan</p>
                <p className="text-xs text-zinc-500 font-mono mt-1">Free forever · Unauthenticated scans only</p>
              </div>
              <Link
                href="/pricing"
          ...
          <section className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p className="text-[10px] font-mono text-zinc-600 leading-relaxed uppercase tracking-widest">
                API access is available for Growth and Scale plans. <Link href="/pricing" className="text-zinc-500 hover:text-white underline">Upgrade to access</Link>.
              </p>
            </div>
          </section>
        </div>
